...
2.Responsive Layout: Optimized for all devices using CSS Grid and Flexbox, ensuring a seamless experience from mobile to desktop.

3.Semantic HTML5: Built with web standards and accessibility (ARIA labels) in mind.

4.Project Gallery: Highlights key applications like Tanite-POS, Weather Consultant, and Password Strength Checker.

        Built With
1.HTML5: Semantic structure for SEO and accessibility.

2.CSS3: Custom styling featuring CSS variables, Grid, Flexbox, and Keyframe animations.

3.Google Fonts: Utilizing the 'Inter' typeface for professional typography.

        Lessons Learned
During the development of this portfolio, I reached several important milestones in my coding journey:
